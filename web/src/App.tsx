  ...
  return (
    <header className="site-header">
      ...
      <div className="header-actions">
        ...
        <a className="button button-small button-primary" href="https://discord.com/oauth2/authorize?client_id=1484653109576732692&permissions=8&scope=bot%20applications.commands" target="_blank" rel="noreferrer">Add to Discord</a>
      </div>
    </header>
  );
}
  ...
  return <><PublicHeader page="home" /><main>
    <section className="hero shell">
      <div className="hero-copy">
        ...
        <div className="hero-buttons"><a className="button button-primary" href="https://discord.com/oauth2/authorize?client_id=1484653109576732692&permissions=8&scope=bot%20applications.commands" target="_blank" rel="noreferrer">Invite Niko <Icon name="arrow" /></a><a className="button button-muted" href="/commands" onClick={(e) => { e.preventDefault(); navigate("/commands"); }}>Explore commands</a></div>
    ...
    <section className="shell callout"><div><div className="section-kicker">Ready when you are</div><h2>A calmer, cleverer home<br />for your community.</h2></div><a className="button button-primary" href="https://discord.com/oauth2/authorize?client_id=1484653109576732692&permissions=8&scope=bot%20applications.commands" target="_blank" rel="noreferrer">Bring Niko in <Icon name="arrow" /></a></section>
  </main><Footer /></>;
}
...
function DashboardPage() {
  ...
  if (!guilds.length) return <><PublicHeader page="dashboard" /><main className="auth-page"><div className="auth-card"><span className="auth-mark">n</span><div className="eyebrow">No workspace yet</div><h1>No managed<br /><em>servers found.</em></h1><p>Niko needs to be in a server where your Discord account has Manage Server permission.</p><a className="button button-primary" href="https://discord.com/oauth2/authorize?client_id=1484653109576732692&permissions=8&scope=bot%20applications.commands" target="_blank" rel="noreferrer">Invite Niko <Icon name="arrow" /></a></div></main></>;
