...
export function StaffDashboardPage() {
  ...
  const save = async () => { setError(""); setMessage(""); try { await saveStaffProfile(form, auth.csrf_token); setMessage("Your public team listing was saved."); } catch (reason) { setError(reason instanceof Error ? reason.message : "Could not save listing."); } };
