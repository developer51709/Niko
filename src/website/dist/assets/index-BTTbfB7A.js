var Xm=Object.defineProperty;var Ym=(o,c,l)=>c in o?Xm(o,c,{enumerable:!0,configurable:!0,writable:!0,value:l}):o[c]=l;var hu=(o,c,l)=>Ym(o,typeof c!="symbol"?c+"":c,l);(function(){const c=document.createElement("link").relList;if(c&&c.supports&&c.supports("modulepreload"))return;for(const m of document.querySelectorAll('link[rel="modulepreload"]'))d(m);new MutationObserver(m=>{for(const p of m)if(p.type==="childList")for(const v of p.addedNodes)v.tagName==="LINK"&&v.rel==="modulepreload"&&d(v)}).observe(document,{childList:!0,subtree:!0});function l(m){const p={};return m.integrity&&(p.integrity=m.integrity),m.referrerPolicy&&(p.referrerPolicy=m.referrerPolicy),m.crossOrigin==="use-credentials"?p.credentials="include":m.crossOrigin==="anonymous"?p.credentials="omit":p.credentials="same-origin",p}function d(m){if(m.ep)return;m.ep=!0;const p=l(m);fetch(m.href,p)}})();var to={exports:{}},Ar={},no={exports:{}},se={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var gu;function Zm(){if(gu)return Ar;gu=1;var o=vo(),c=Symbol.for("react.element"),l=Symbol.for("react.fragment"),d=Object.prototype.hasOwnProperty,m=o.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p={key:!0,ref:!0,__self:!0,__source:!0};function v(T,w,A){var C,S={},P=null,F=null;A!==void 0&&(P=""+A),w.key!==void 0&&(P=""+w.key),w.ref!==void 0&&(F=w.ref);for(C in w)d.call(w,C)&&!p.hasOwnProperty(C)&&(S[C]=w[C]);if(T&&T.defaultProps)for(C in w=T.defaultProps,w)S[C]===void 0&&(S[C]=w[C]);return{$$typeof:c,type:T,key:P,ref:F,props:S,_owner:m.current}}return Ar.Fragment=l,Ar.jsx=v,Ar.jsxs=v,Ar}var vu;function eh(){return vu||(vu=1,to.exports=Zm()),to.exports}var r=eh(),D=vo(),Ks={},ro={exports:{}},et={},so={exports:{}},ao={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var yu;function th(){return yu||(yu=1,(function(o){function c(O,Z){var V=O.length;O.push(Z);e:for(;0<V;){var y=V-1>>>1,E=O[y];if(0<m(E,Z))O[y]=Z,O[V]=E,V=y;else break e}}function l(O){return O.length===0?null:O[0]}function d(O){if(O.length===0)return null;var Z=O[0],V=O.pop();if(V!==Z){O[0]=V;e:for(var y=0,E=O.length,re=E>>>1;y<re;){var ie=2*(y+1)-1,ce=O[ie],ue=ie+1,fe=O[ue];if(0>m(ce,V))ue<E&&0>m(fe,ce)?(O[y]=fe,O[ue]=V,y=ue):(O[y]=ce,O[ie]=V,y=ie);else if(ue<E&&0>m(fe,V))O[y]=fe,O[ue]=V,y=ue;else break e}}return Z}function m(O,Z){var V=O.sortIndex-Z.sortIndex;return V!==0?V:O.id-Z.id}if(typeof performance=="object"&&typeof performance.now=="function"){var p=performance;o.unstable_now=function(){return p.now()}}else{var v=Date,T=v.now();o.unstable_now=function(){return v.now()-T}}var w=[],A=[],C=1,S=null,P=3,F=!1,I=!1,B=!1,b=typeof setTimeout=="function"?setTimeout:null,U=typeof clearTimeout=="function"?clearTimeout:null,N=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function q(O){for(var Z=l(A);Z!==null;){if(Z.callback===null)d(A);else if(Z.startTime<=O)d(A),Z.sortIndex=Z.expirationTime,c(w,Z);else break;Z=l(A)}}function te(O){if(B=!1,q(O),!I)if(l(w)!==null)I=!0,qe(oe);else{var Z=l(A);Z!==null&&Ne(te,Z.startTime-O)}}function oe(O,Z){I=!1,B&&(B=!1,U(pe),pe=-1),F=!0;var V=P;try{for(q(Z),S=l(w);S!==null&&(!(S.expirationTime>Z)||O&&!ne());){var y=S.callback;if(typeof y=="function"){S.callback=null,P=S.priorityLevel;var E=y(S.expirationTime<=Z);Z=o.unstable_now(),typeof E=="function"?S.callback=E:S===l(w)&&d(w),q(Z)}else d(w);S=l(w)}if(S!==null)var re=!0;else{var ie=l(A);ie!==null&&Ne(te,ie.startTime-Z),re=!1}return re}finally{S=null,P=V,F=!1}}var z=!1,J=null,pe=-1,Se=5,Ae=-1;function ne(){return!(o.unstable_now()-Ae<Se)}function we(){if(J!==null){var O=o.unstable_now();Ae=O;var Z=!0;try{Z=J(!0,O)}finally{Z?_e():(z=!1,J=null)}}else z=!1}var _e;if(typeof N=="function")_e=function(){N(we)};else if(typeof MessageChannel<"u"){var Be=new MessageChannel,St=Be.port2;Be.port1.onmessage=we,_e=function(){St.postMessage(null)}}else _e=function(){b(we,0)};function qe(O){J=O,z||(z=!0,_e())}function Ne(O,Z){pe=b(function(){O(o.unstable_now())},Z)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(O){O.callback=null},o.unstable_continueExecution=function(){I||F||(I=!0,qe(oe))},o.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Se=0<O?Math.floor(1e3/O):5},o.unstable_getCurrentPriorityLevel=function(){return P},o.unstable_getFirstCallbackNode=function(){return l(w)},o.unstable_next=function(O){switch(P){case 1:case 2:case 3:var Z=3;break;default:Z=P}var V=P;P=Z;try{return O()}finally{P=V}},o.unstable_pauseExecution=function(){},o.unstable_requestPaint=function(){},o.unstable_runWithPriority=function(O,Z){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var V=P;P=O;try{return Z()}finally{P=V}},o.unstable_scheduleCallback=function(O,Z,V){var y=o.unstable_now();switch(typeof V=="object"&&V!==null?(V=V.delay,V=typeof V=="number"&&0<V?y+V:y):V=y,O){case 1:var E=-1;break;case 2:E=250;break;case 5:E=1073741823;break;case 4:E=1e4;break;default:E=5e3}return E=V+E,O={id:C++,callback:Z,priorityLevel:O,startTime:V,expirationTime:E,sortIndex:-1},V>y?(O.sortIndex=V,c(A,O),l(w)===null&&O===l(A)&&(B?(U(pe),pe=-1):B=!0,Ne(te,V-y))):(O.sortIndex=E,c(w,O),I||F||(I=!0,qe(oe))),O},o.unstable_shouldYield=ne,o.unstable_wrapCallback=function(O){var Z=P;return function(){var V=P;P=Z;try{return O.apply(this,arguments)}finally{P=V}}}})(ao)),ao}var xu;function nh(){return xu||(xu=1,so.exports=th()),so.exports}/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const fh=o=>{for(const c in o)if(c.startsWith("aria-")||c==="role"||c==="title")return!0;return!1},gh=D.createContext({}),vh=()=>D.useContext(gh),yh=D.forwardRef(({color:o,size:c,strokeWidth:l,absoluteStrokeWidth:d,className:m="",children:p,iconNode:v,...T},w)=>{const{size:A=24,strokeWidth:C=2,absoluteStrokeWidth:S=!1,color:P="currentColor",className:F=""}=vh()??{},I=d??S?Number(l??C)*24/Number(c??A):l??C;return D.createElement("svg",{ref:w,...io,width:c??A??io.width,height:c??A??io.height,stroke:o??P,strokeWidth:I,className:$u("lucide",F,m),...!p&&!fh(T)&&{"aria-hidden":"true"},...T},[...v.map(([B,b])=>D.createElement(B,b)),...Array.isArray(p)?p:[p]])});/**
 * @license lucide-react v1.39.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const at=(o,c)=>{const l=D.forwardRef(({className:d,...m},p)=>D.createElement(yh,{ref:p,iconNode:c,className:$u(`lucide-${hh(Pu(o))}`,`lucide-${o}`,d),...m}));return l.displayName=Pu(o),l};/**
 * @license lucide-react v1.39.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
