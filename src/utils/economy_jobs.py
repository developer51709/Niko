...
SHOP_ITEMS: dict[str, dict] = {
    ...
    "coin_booster": {
        ...
        "min_level": 5,
        "effect": "coin_booster",
        "description": "Next coinflip gets 60/40 odds in your favor.",
    },
    "streak_insurance": {
    ...
    "double_down_token": {
        ...
        "description": "Your next gambling win pays 1.5x the normal amount.",
    },
    "lucky_horseshoe": {
        ...
        "min_level": 3,
        "effect": "work_boost",
        "description": "+10% on your next work reward.",
    },
    # ── Upgrades ───────────────────────────────────────────────────
    "vault_upgrade": {
        "name": "Vault Upgrade",
