...
def card_rank():
    ...
    body = (
        ...
        'font-size="18">Level ' + str(level) + ' &middot; Rank #' + str(rank) + '</text>'
...
def card_economy():
    ...
    body = (
        ...
        'font-size="14" font-weight="500">' + _safe(job) + ' &middot; Level ' + str(level) + '</text>'
...
def card_daily():
    ...
    body = (
        ...
        'font-size="14">' + _safe(job) + ' &middot; Streak: ' + str(streak) + ' days</text>'
...
def card_coinflip():
    ...
    body = (
        ...
        'font-size="12" font-weight="700">COINFLIP &mdash; ' + rt + '</text>'
        ...
        'font-size="13">Called ' + call + ' &middot; Got ' + result + '</text>'
