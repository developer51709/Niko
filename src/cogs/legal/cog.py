    ...
    "normal": {
        "en": {
            ...
            "privacy_body": (
                ...
                "not stored permanently except for AI conversation history (last 3 exchanges, per-user) and snipe cache (last deleted/edited message per channel, cleared on restart). Daily aggregate message, join, and leave counts are stored for the dashboard without message text or member IDs.\n"
        ...
        "de": {
            ...
            "privacy_body": (
                ...
                "dauerhaft gespeichert wird nur der KI-Gesprächsverlauf (letzte 3 Austausche pro Nutzer) sowie der Snipe-Cache (letzte gelöschte/bearbeitete Nachricht pro Kanal, beim Neustart gelöscht). Tägliche aggregierte Nachrichten-, Beitritts- und Austrittszahlen werden für das Dashboard ohne Nachrichteninhalte oder Nutzer-IDs gespeichert.\n"
        ...
        "es": {
            ...
            "privacy_body": (
                ...
                "almacenado permanentemente solo el historial de conversación de IA (últimos 3 intercambios por usuario) y caché de snipe (último mensaje borrado/editado por canal, se borra al reiniciar). El panel guarda totales diarios agregados de mensajes, entradas y salidas sin texto de mensajes ni IDs de miembros.\n"
